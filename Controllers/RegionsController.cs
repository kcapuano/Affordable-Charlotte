    ...
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string? id)
        {
            ...
            var region = await _context.Regions
                .FirstOrDefaultAsync(m => m.regionName == id);
            if (region == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("regionID,regionName,city,state,price")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("regionID,regionName,city,state,price")] Region region)
        {
